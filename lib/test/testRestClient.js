...
var cryptoutil = require('../ibm_apm_restclient/lib/plugins/cryptoutil');
var HttpsProxyAgent = require('../ibm_apm_restclient/lib/restclient/https-proxy-agent');
...
var dcRegPayload = {
    ...
    type: ['provider'],
    startTime: '2017-08-24T03:57:05.733Z',
    properties: {
        name: 'NodeJSDC',
        version: '0.10.0.1',
        monitoringLevel: 'L1',
