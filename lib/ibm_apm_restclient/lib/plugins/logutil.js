...
var loglevel = process.env.KNJ_LOG_LEVEL ? process.env.KNJ_LOG_LEVEL.toUpperCase() : 'INFO';
if (!(loglevel === 'OFF' || loglevel === 'ERROR' || loglevel === 'INFO' ||
...
exports.getLogger = function(tag) {
    var logger;
    if (!(process.env.KNJ_LOG_TO_FILE && process.env.KNJ_LOG_TO_FILE.toLowerCase() === 'true')) {
