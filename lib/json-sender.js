...
JsonSender.prototype.send = function send(data) {
    ...
    var reqsSummPayload =
        this.genRequestSummaries(commonTools.merge([dimensions_content, resid1]), data);
    ...
    if (this.nodeAppRuntimeMD5String) {
        ...
        var sysPayload = this.genSysInfo(commonTools.merge([dimensions_content, resid1]), data, enginePayloadMeta);
    ...
    for (var index in data.httpReq) {
        ...
        requestsSummaryPayload.push({
            ...
            metrics: {
                ...
                averageResponseTime: req['REQ_RESP_TIME'],
