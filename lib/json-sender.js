...
JsonSender.prototype.send = function send(data) {
    ...
    let resid2 = {};
    if (this.nodeAppRuntimeMD5String) {
        resid1.nodeApplicationRuntimeResourceID = this.nodeAppRuntimeMD5String;
    }
    if (this.nodeRuntimeMD5String) {
        resid1.nodeServerResourceID = this.nodeRuntimeMD5String;
        resid2.nodeServerResourceID = this.nodeRuntimeMD5String;
    }
    ...
    if (this.instanceMD5String) {
        resid1.nodeApplicationInstanceResourceID = this.instanceMD5String;
        resid2.nodeApplicationInstanceResourceID = this.instanceMD5String;
    }
