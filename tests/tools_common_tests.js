...
tap.test('common tools.', function(t) {
    var commontools = require('../lib/tool/common');
    commontools.transferTimezoneToString(-50);
    commontools.transferTimezoneToString(10);
    commontools.appIDDecBluemix({
        APP_GUID: '11100000000000000000000000000',
        APP_NAME: 'unittest000000000000000000000'
    });
    commontools.combineArr(['a', 'b'], '=', ['c', 'd']);
    commontools.appGuidDec('11100000000000000000000000000', 'unittest000000000000000000000');
